...
trained_model_path = fullfile('data', strcat(type_of_lesion, '-detection-model'));
...
% CNN path
cnn_path = fullfile('data', strcat(type_of_lesion, '-detection-model'));
