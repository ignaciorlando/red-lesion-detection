...
trained_model_path = strcat('C:\Users\USUARIO\Dropbox\RetinalImaging\Writing\drscreening2016paper\data\', type_of_lesion, '-detection-model');
...
% CNN path
cnn_path = strcat('C:\Users\USUARIO\Dropbox\RetinalImaging\Writing\drscreening2016paper\data\', type_of_lesion, '-detection-model');
...
test_data_path = 'C:\_diabetic_retinopathy_testing_software';
test_images_path = 'C:\_diabetic_retinopathy_testing_software';

% Path were results will be saved
results_path = 'C:\_diabetic_retinopathy_testing_software\results';