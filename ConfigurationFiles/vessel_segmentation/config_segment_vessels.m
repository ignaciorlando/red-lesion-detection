...
image_folder = 'C:\_diabetic_retinopathy_testing_software';

% folder where vessel segmentations will be saved
output_segmentations_folder = 'C:\_diabetic_retinopathy_testing_software';

% The segmentation model has to be located in this folder
modelLocation = 'C:\_diabetic_retinopathy_testing_software\segmentation-model';
